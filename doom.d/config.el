...
(setq org-directory "/storage/emulated/0/org/")
(setq org-agenda-files '("/storage/emulated/0/org/_GTD.org"))
...
(use-package calfw-blocks
  ...
  (defun ngm/org-day-blocks-agenda ()
        (interactive)
...
;; Calendar showing org entries from files
  (defun ngm/org-day-blocks ()
   ...
   (list
    (cfw:org-create-source "medium purple")
    (cfw:org-create-file-source "Day" "/storage/emulated/0/org/day-2024-03-28.org" "green")
    )
   :view 'block-day)))
